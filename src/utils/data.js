export const data = [
  {
    ...
    filters: {
      ...
      paymentMethod: {
        ...
        select: "multiple",
        type: "checkbox",
        options: ["Cash", "Mortgage", "Installments without bank"],
      },
    },
  },
  {
    ...
    filters: {
      ...
      exteriorColor: {
        ...
        select: "multiple",
        type: "checkbox",
        options: ["White", "Black", "Grey", "Red", "Yellow", "Blue", "Green", "Silver", "Orange", "Purple", "Brown", "Pink", "Beige", "Maroon", "Turquoise"],
      },
      additionalFeatures: {
    ...
    subcategories: [
      {
        ...
        path: "/real-estate?subcategory=apartments-for-rent",
      },
      {
        name: "Apartments for Sale",
        path: "/real-estate?subcategory=apartments-for-sale",
      },
      {
        name: "Building for Rent",
        path: "/real-estate?subcategory=building-for-rent",
      },
      {
        name: "Building for Sale",
        path: "/real-estate?subcategory=building-for-sale",
      },
      {
        name: "Camps for Rent",
        path: "/real-estate?subcategory=camps-for-rent",
      },
      {
        name: "Chalets for Sale",
        path: "/real-estate?subcategory=chalets-for-sale",
      },
      {
        name: "Commercial Lands for Sale",
        path: "/real-estate?subcategory=commercial-lands-for-sale",
      },
      {
        name: "Compound for Rent",
        path: "/real-estate?subcategory=compound-for-rent",
      },
      {
        name: "Compound for Sale",
        path: "/real-estate?subcategory=compound-for-sale",
      },
      {
        name: "Farm for Rent",
        path: "/real-estate?subcategory=farm-for-rent",
      },
      {
        name: "Farms for Sale",
        path: "/real-estate?subcategory=farms-for-sale",
      },
      {
        name: "Floor for Sale",
        path: "/real-estate?subcategory=floor-for-sale",
      },
      {
        name: "Floors for Rent",
        path: "/real-estate?subcategory=floors-for-rent",
      },
      {
        name: "Hall for Rent",
        path: "/real-estate?subcategory=hall-for-rent",
      },
      {
        name: "Houses for Rent",
        path: "/real-estate?subcategory=houses-for-rent",
      },
      {
        name: "Houses for Sale",
        path: "/real-estate?subcategory=houses-for-sale",
      },
      {
        name: "Lands for Sale",
        path: "/real-estate?subcategory=lands-for-sale",
      },
      {
        name: "Offices for Rent",
        path: "/real-estate?subcategory=offices-for-rent",
      },
      {
        name: "Rest Houses for Rent",
        path: "/real-estate?subcategory=rest-houses-for-rent",
      },
      {
        name: "Rest Houses for Sale",
        path: "/real-estate?subcategory=rest-houses-for-sale",
      },
      {
        name: "Rooms for Rent",
        path: "/real-estate?subcategory=rooms-for-rent",
      },
      {
        name: "Shops for Rent",
        path: "/real-estate?subcategory=shops-for-rent",
      },
      {
        name: "Shops for Transfer",
        path: "/real-estate?subcategory=shops-for-transfer",
      },
      {
        name: "Villas for Rent",
        path: "/real-estate?subcategory=villas-for-rent",
      },
      {
        name: "Villas for Sale",
        path: "/real-estate?subcategory=villas-for-sale",
      },
      {
        name: "Warehouse for Sale",
        path: "/real-estate?subcategory=warehouse-for-sale",
      },
      {
        name: "Warehouse for Rent",
        path: "/real-estate?subcategory=warehouse-for-rent",
      },
    ],
    filters: {
      price: {
