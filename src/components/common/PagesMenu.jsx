...
const PagesMenu = ({ activeMenus }) => {
  ...
  return (
    <li
      className={
        activeMenus === "/about" ||
        activeMenus === "/service-details" ||
        activeMenus === "/pricing" ||
        activeMenus === "/faq" ||
        activeMenus === "/gallery" ||
        activeMenus === "/categories" ||
        activeMenus === "/howitworks" ||
        activeMenus === "/terms-condition" ||
        activeMenus === "/privacy-policy"
          ? "has-submenu active"
          : "has-submenu"
      }
    >
      <Link to="" className={menu3 ? "submenu" : ""}>
        Pages{" "}
        <i className="fas fa-chevron-down" onClick={() => setMenu3(!menu3)}></i>
      </Link>
