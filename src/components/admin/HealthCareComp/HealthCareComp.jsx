  ...
  useEffect(() => {
    ...
    const fetchHealthcare = async () => {
      try {
        ...
        setFilteredCars(healthcareData);
        setLoading(false);

        console.log(healthcareData, "healthcareData_________");
      } catch (error) {
        console.error("Error getting HEALTHCARE:", error);
        setLoading(false);
      }
    };
