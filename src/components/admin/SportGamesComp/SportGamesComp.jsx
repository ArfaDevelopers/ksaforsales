...
const SPORTSGAMESComp = () => {
      ...
      <div className="main-wrapper">
        ...
        >
          ...
          <div>
            ...
            >
              Nike Air Zoom Pegasus Running Shoes for Sale
            </h1>
          </div>
                ...
                <Row className="my-3">
                  <Col>
                    ...
                    <div className="position-relative">
                      <input
                        type="search"
                        placeholder="E.g Shoes in America"
                  ...
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      <Form.Group className="mb-3">
                        {/* Checkbox Selection */}
                        <div style={{ maxWidth: "300px", marginTop: "20px" }}>
                          {["Mesh Upper", "Foam Midsole", "Rubber Outsole"].map(
                            (car, index) => (
                              <div
                                key={index}
                                style={{
                              ...
                              >
                                <Form.Check
                                  ...
                                  label={car}
                                  name={car} // Use the name attribute for identification
                                  onChange={handleCheckboxChangeMaterial}
                                  // defaultChecked={car === "Nissan"} // Pre-check Nissan
                                />
                                <span
                                  style={{ fontWeight: "bold", color: "#333" }}
                  ...
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      <Form.Group className="mb-3">
                        {/* Checkbox Selection */}
                        <div style={{ maxWidth: "300px", marginTop: "20px" }}>
                          {["Men's Shoes", "Unisex", "Women's Shoes"].map(
                            (car, index) => (
                              <div
                                key={index}
                                style={{
  ...
  `}</style>
        ...
        >
          ...
          >
            <h2>Nike Air Zoom Pegasus Running Shoes for Sale in Newyork</h2>
            <p>
            ...
            <h2>
              Used Nike Air Zoom Pegasus Running Shoes for Sale in Newyork
            </h2>
            <p>
              Lorem ipsum dolor sit amet consectetur. Lacus lacus est praesent
              gravida quam urna arcu integer. Semper vitae velit sed quisque
            ...
            <h2>Browse More Used Nike Air Zoom Pegasus Running Shoes</h2>
            <p style={{ color: "#2d4fad" }}>
              View Nike Air Zoom Pegasus Running Shoes by Cities
            </p>
