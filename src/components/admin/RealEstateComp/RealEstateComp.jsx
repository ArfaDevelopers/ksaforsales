...
const RealEstateComp = () => {
    ...
    const fetchRealEstate = async () => {
      try {
        ...
        const query = searchText
          ...
          : "";
        const response = await fetch(
          `http://168.231.80.24:9002/route/REALESTATECOMP${query}`
        );
  ...
  const filterCars = (
    ...
    if (Frequency?.length > 0) {
      filtered = filtered.filter((car) => Frequency.includes(car.Frequency));
    }
  ...
  `}</style>
                  ...
                  <Accordion className="mt-3">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        <div style={{ maxWidth: "300px", margin: "20px" }}>
                          <Form.Group>
                            {["Dailly", "Weekly", "Montly", "Yearly"].map(
                              (color) => (
                                <div
                                  key={color}
                                  style={{
                ...
                <div>
                  ...
                  <Accordion className="mt-3">
                    <Accordion.Item eventKey="0">
                      <Accordion.Header>Residence Type</Accordion.Header>
                      <Accordion.Body>
                        <div style={{ maxWidth: "300px", margin: "20px" }}>
                          <Form.Group>
                            {["Single", "Families"].map((color) => (
                              <div
                                key={color}
                                style={{
                                  display: "flex",
