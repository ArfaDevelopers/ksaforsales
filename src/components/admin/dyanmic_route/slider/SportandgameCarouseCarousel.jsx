...
import img from "./sports.png";

export default function SportandgameCarouseCarousel() {
  ...
  const slider = useRef();
  return (
		<section className="featured-section-color  mb-3   Sport&games_card_section">
			<div className="container">
				<div className="row align-items-center">
					<div className="featuresection_infodev">
						<h4 className="featuresection_header">Sport & Games</h4>
						<button className="featuresection_btn">View All</button>
					</div>

					<div className="feature-section-info">
						<ul className="info-list">
							<li className="active">Football</li>
							<li>Cricket</li>
							<li>Gloves</li>
							<li>Stumps</li>
						</ul>
					...
					<div className="col-md-12">
						<div>
							<Slider
								ref={slider}
								{...settings}
								className=" featured-slider grid-view   mb-5 ">
                          ...
                          <div className="blog-author text-end">
                            <span>
                              ...
                              <i className="feather-eye"></i>4000{" "}
												...
												{/* </div> */}
												<h6>
													<Link to="/index">Sport Kits</Link>
												</h6>
												<div
													className="location-info"
													style={{ fontSize: "0.7rem" }}>
													2 Kits | Color | Cricket Kit
												</div>
                          ...
                          <div className="blog-author text-end">
                            <span>
                              ...
                              <i className="feather-eye"></i>4000{" "}
												...
												{/* </div> */}
												<h6>
													<Link to="/service-details">Sport Kits</Link>
												</h6>
												<div
													className="location-info"
													style={{ fontSize: "0.7rem" }}>
