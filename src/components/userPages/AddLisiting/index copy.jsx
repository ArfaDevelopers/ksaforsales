...
const AddLisiting = () => {
  ...
  console.log(Make?.value, "Make_________");
  useEffect(() => {
  ...
  const isFormValid = () => {
    ...
    return nonEmptyFields.length > totalFields / 4;
  };
        ...
        <div className="container">
          ...
          <div className="profile-content">
            <div className="messages-form">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="form-group formlast-input">
                    ...
                    <input
                      type="text"
                      name="Phone" // Added name for proper state binding
                  ...
                  <div className="row">
                    <div className="p-4" style={{ marginTop: "-1rem" }}>
                      ...
                      {/* Display Cities Based on Selected Country */}
                      ...
                      <div className="card-body">
                        ...
                        <Select
                          ...
                          value={statesList.find(
                            (state) => state.value === formData.States
                          )}
                    ...
                    <div
                      className="form-group formlast-input"
              ...
              {Category === "Electronics" ? (
                <>
                  <div className="card" style={{ marginTop: "-4.5rem" }}>
                    <div className="card-header">
                      <h4>Brand </h4>
                    </div>
                    <div className="card-body">
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.StorageType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Processor === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ScreenSize === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "UHD", label: "UHD" },
                            { name: "AMD Radeon", label: "AMD Radeon" },
                            {
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.GraphicsCard === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "5-8 hours", label: "5-8 hours" },
                            { name: "8-12 hours", label: "8-12 hours" },
                            {
                              name: "12 hours",
                              label: "12 hours",
                            },
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.BatteryLife === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Retina Display", label: "Retina Display" },
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Bluetooth 4.0", label: "Bluetooth 4.0" },
                            {
                              name: "Bluetooth 5.0",
                              label: "Bluetooth 5.0",
                            },
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Connectivity === area.name}
                ...
                <>
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group">
                        <label className="col-form-label">KM Driven</label>
                        <input
                          type="text"
                          name="kmDriven"
                          className="form-control pass-input"
                                ...
                                <li key={feature.name}>
                                  <label className="custom_check">
                                    <input
                                      ...
                                      name={feature.name}
                                      checked={
                                        formData.Transmission === feature.name
                                      }
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Downtown Dubai", label: "Downtown Dubai" },
                            { name: "Dubai Marina", label: "Dubai Marina" },
                            { name: "Jumeirah", label: "Jumeirah" },
                            { name: "Deira", label: "Deira" },
                            { name: "Business Bay", label: "Business Bay" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Emirates === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Registeredin === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "BMW", label: "BMW" },
                            { name: "Lamborghini", label: "Lamborghini" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.TrustedCars === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ExteriorColor === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.SellerType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ModelCategory === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.NumberofDoors === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "V6 Engine", label: "V6 Engine" },
                            { name: "V8 Engine", label: "V8 Engine" },
                            {
                              name: "Inline-6 (I6) Engine",
                              label: "Inline-6 (I6) Engine",
                            },
                            { name: "V12 Engine", label: "V12 Engine" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.EngineType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Assembly === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Sedan (Saloon)", label: "Sedan (Saloon)" },
                            { name: "SUV", label: "SUV" },
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.BodyType === area.name}
                  ...
                  <div className="form-group">
                    <label className="col-form-label">Engine Capacity</label>
                    <input
                      type="text"
                      name="EngineCapacity"
                      className="form-control"
                  ...
                  <div className="form-group">
                    <label className="col-form-label">Manufacture Year </label>
                    <input
                      type="text"
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Regular fit", label: "Regular fit" },
                            { name: "Slim fit", label: "Slim fit" },
                            { name: "Oversized", label: "Oversized" },
                            { name: "Relaxed fit", label: "Relaxed fit" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Cotton blend", label: "Cotton blend" },
                            { name: "Stretch denim", label: "Stretch denim" },
                            { name: "Raw denim", label: "Raw denim" },
                            { name: "Recycled denim", label: "Recycled denim" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Material === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Distressed", label: "Distressed" },
                            { name: "Vintage", label: "Vintage" },
                            { name: "Ripped", label: "Ripped" },
                            { name: "Stone-washed", label: "Stone-washed" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.StyleDesign === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Button-down", label: "Button-down" },
                            { name: "Zipper", label: "Zipper" },
                            { name: "Snap closure", label: "Snap closure" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ClosureType === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Shawl collar", label: "Shawl collar" },
                            { name: "No collar", label: "No collar" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.CollarType === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Long sleeve", label: "Long sleeve" },
                            { name: "Short sleeve", label: "Short sleeve" },
                            { name: "Sleeveless", label: "Sleeveless" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.SleeveLength === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Acid-wash", label: "Acid-wash" },
                            { name: "Stone-wash", label: "Stone-wash" },
                            { name: "Light-wash", label: "Light-wash" },
                            { name: "Dark-wash", label: "Dark-wash" },
                            { name: "Black-wash", label: "Black-wash" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.WashType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Features === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Brand Seller", label: "Brand Seller" },
                            { name: "Individuals", label: "Individuals" },
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Wrist monitor", label: "Wrist monitor" },
                            { name: "Finger monitor", label: "Finger monitor" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "60-180 mmHg", label: "60-180 mmHg" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.MeasurementRange === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Accuracy === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "LCD Display", label: "LCD Display" },
                            {
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.CuffSize === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.DisplayType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.BatteryType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Compatibility === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.MeasurementUnits === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.SpeedofMeasurement === area.name
                                  }
                                  onChange={handleSpeedofMeasurementChange}
                                />
                                <span className="checkmark" /> {area.label}
                              </label>
                            </li>
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Data Scientist", label: "Data Scientist" },
                            {
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.JobTitle === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Entry-level", label: "Entry-level" },
                            { name: "Mid-level", label: "Mid-level" },
                            { name: "Senior-level", label: "Senior-level" },
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Industry === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Soft Skills", label: "Soft Skills" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.SubjectCategories === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.SkillLevel === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ContentType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Language === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Short-term", label: "Short-term" },
                            {
                              name: "Medium-term",
                              label: "Medium-term",
                            },
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Duration === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.PropertyType === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "3 Bedroom", label: "3 Bedroom" },
                            { name: "4 Bedroom", label: "4 Bedroom" },
                            { name: "5 Bedroom", label: "5 Bedroom" },
                            { name: "5+ Bedrooms", label: "5+ Bedrooms" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Amenities === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.PropertyFeatures === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.BuildingType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Accessibility === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Direct owner", label: "Direct owner" },
                            {
                  ...
                  <div className="card" style={{ marginTop: "-4rem" }}>
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Specific dates", label: "Specific dates" },
                            {
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Family room", label: "Family room" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.RoomType === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Under Armour", label: "Under Armour" },
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Running Shoes", label: "Running Shoes" },
                            { name: "Walking Shoes", label: "Walking Shoes" },
                            { name: "Athletic Shoes", label: "Athletic Shoes" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ShoeCategory === area.name}
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Men: 6–15 (US)", label: "Men: 6–15 (US)" },
                            {
                              name: "Women: 5–12 (US)",
                              label: "Women: 5–12 (US)",
                            },
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Mesh Upper", label: "Mesh Upper" },
                            { name: "Foam Midsole", label: "Foam Midsole" },
                            { name: "Rubber Outsole", label: "Rubber Outsole" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            { name: "Men's Shoes", label: "Men's Shoes" },
                            { name: "Unisex", label: "Unisex" },
                            { name: "Women's Shoes", label: "Women's Shoes" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Availability === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.ColorOptions === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Temperament === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.HealthStatus === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.TrainingLevel === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.DietaryPreferences === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.MAGAZINESCategory === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  ...
                                  name={area.name}
                                  checked={
                                    formData.SubscriptionType === area.name
                                  }
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.IssueType === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.AgeGroup === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Loud (>75 dB)", label: "Loud (>75 dB)" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.NoiseLevel === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.Capacity === area.name}
                            ...
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                                  type="checkbox"
                                  name={area.name}
                                  checked={formData.PowerSource === area.name}
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Multi-surface", label: "Multi-surface" },
                          ].map((area) => (
                            <li key={area.name}>
                              <label className="custom_check">
                                <input
                      ...
                      <div className="form-group featuresform-list mb-0">
                        <ul>
                          {[
                            ...
                            { name: "Lightweight", label: "Lightweight" },
                            {
              ...
              <div className="card" style={{ marginTop: "-3rem" }}>
                ...
                <div className="card-body">
                  <div className="form-group">
                    ...
                    <input
                      type="text"
                      name="Email" // Added name for proper state binding
                  ...
                  <div className="form-group">
                    ...
                    <input
                      type="text"
                      name="Website" // Added name for proper state binding
              ...
              <div>
                ...
                {/* Other sections, such as map and feature components, can follow here */}
              </div>
              <button
                onClick={saveToFirestore}
                disabled={!isChecked || uploading} // Disable unless checkbox is checked & not uploading
