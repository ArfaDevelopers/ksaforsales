      ...
      <section className="car-service-section common-padding">
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div
              className="col-lg-3 col-md-4 col-sm-6 aos"
              data-aos="flip-down"
            >
              <div className="car-service-container ">
            ...
            <div className="col-lg-3">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={200}
                >
                  <img src={car_location_1} className="img-fluid" alt="" />
                  <span>Las Vegas</span>
                </div>
              </Link>
            </div>
            <div className="col-lg-5">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={400}
                >
                  <img src={car_location_2} className="img-fluid" alt="" />
                  <span>Singapore</span>
                </div>
              </Link>
            </div>
            <div className="col-lg-4">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={600}
                >
                  <img src={car_location_3} className="img-fluid" alt="" />
                  <span>Denmark</span>
                </div>
              </Link>
            </div>
            <div className="col-lg-4">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={800}
                >
                  <img src={car_location_4} className="img-fluid" alt="" />
                  <span>France</span>
                </div>
              </Link>
            </div>
            <div className="col-lg-5">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={1000}
                >
                  <img src={car_location_5} className="img-fluid" alt="" />
                  <span>Indonesia</span>
                </div>
              </Link>
            </div>
            <div className="col-lg-3">
              <Link to="/service-details">
                <div
                  ...
                  data-aos-delay={1200}
                >
                  <img src={car_location_6} className="img-fluid" alt="" />
                  <span>New York</span>
                </div>
              </Link>
            </div>
